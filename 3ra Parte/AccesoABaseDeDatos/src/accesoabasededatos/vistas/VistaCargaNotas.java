...
private Conexion conexion;
    ...
    public VistaCargaNotas() {
        ...
        cargaAlumnos();   //Carga el comboBox
        
        armaCabeceraTabla();
        
        cargaDatos();   //traer cursadas o no por alumno y llenar tabla
    ...
    private void btGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btGuardarActionPerformed
        ...
        if(filaSeleccionada!=-1){   // si eligio una fila de cursada
        
            
            Alumno a=(Alumno)cbAlumnos.getSelectedItem(); //tomo el objeto alumno del Combo
            
            
            int idMateria=(Integer)modelo.getValueAt(filaSeleccionada,0);  //elemento 0 : idMateria
            int nota=Integer.parseInt((String)modelo.getValueAt(filaSeleccionada,2));  // elemento 2: nota
            
            CursadaData cd=new CursadaData(conexion);
            cd.actualizarNotaCursada(a.getId(), idMateria, nota);   // guardar nota
            borraFilasTabla();
