...
private Conexion conexion;
    ...
    private void btGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btGuardarActionPerformed
        ...
        materiaData.guardarMateria(materia);  // 1
    ...
    private void btBorrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btBorrarActionPerformed
        // TODO add your handling code here:
        int id=Integer.parseInt(jtId.getText());// previamente busque
        materiaData.borrarMateria(id);   // 2
    }//GEN-LAST:event_btBorrarActionPerformed

    private void btActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btActualizarActionPerformed
        // TODO add your handling code here:
        if (jtId.getText()!=null){  // previamente busque
            String nombre=jtNombre.getText();
            Materia materia=new Materia(Integer.parseInt(jtId.getText()),nombre);
             materiaData.actualizarMateria(materia);  // 3
        }
    ...
    private void btBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btBuscarActionPerformed
        // TODO add your handling code here:
        int id=Integer.parseInt(jtId.getText());  // lo que hay en caja
        Materia materia=materiaData.buscarMateria(id); // 4
        if(materia!=null){    // si la encontro
                jtId.setText(materia.getId()+"");
